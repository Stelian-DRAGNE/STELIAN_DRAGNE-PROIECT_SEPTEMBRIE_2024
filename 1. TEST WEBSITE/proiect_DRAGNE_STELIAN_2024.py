""" 
    ...
    Timpul estimat de rulare a celor 15 teste : aproximativ 21 minute si 30 secunde.
...
def test_login(browser: webdriver.Chrome):
    ...
    data_factura_zi = browser.find_element(By.CSS_SELECTOR, "#__orderDay > option:nth-child(17)").click()
    browser.find_element(By.NAME, 'order_day').click()
    data_factura_zi = browser.find_element(By.XPATH, '//*[@id="__orderDay"]/option[17]')
